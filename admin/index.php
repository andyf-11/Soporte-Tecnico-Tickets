...
<head>
  ...
  <meta charset="utf-8" />
  <title>SPE Acceso Administrativo</title>
...
<body class="error-body no-top" style="padding: 0; margin: 0; height: 100%">
  <div class="container">
    <div class="login-container">
      <div class="col-md-5">
        <div class="logo-container">
          <img src="Logo-Gobierno-en-Vertical (1).png" alt="Logo" size="100x100">
        </div>
      ...
      <div class="col-md-5"></div>
        <div class="form-group text-center">
          <a class="btn_back" href="./../">Volver al Sitio</a>
      </div>
